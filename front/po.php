...
<p>目前位置：首頁 > 分類網誌 > <span id="type">健康新知</span></p>
<div class="container">
    ...
    <div class="nav-container">
        <fieldset>
            <legend>分類網誌</legend>
            <div class="nav-item" id="nav1">健康新知</div>
            <div class="nav-item" id="nav2">菸害防治</div>
            <div class="nav-item" id="nav3">癌症防治</div>
            <div class="nav-item" id="nav4">慢性病防治</div>
        </fieldset>
    </div>
